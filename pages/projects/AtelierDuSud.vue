<template>
    <div class="text-slate-100 font-inter scroll-smooth">
        ...
        <section
            ...
            <p class="text-3xl ">L'atelier du sud
                <br><br>
                <span class="text-3xl">
                    Une application web et un site vitrine destiné à un lieu associatif.
                </span>
                <br><br>
                <span class="text-2xl">
        ...
        <section class="my-20 mx-auto w-10/12 flex border-2 border-red-700" id="project-details">
            ...
            <div class="w-2/3 ml-auto flex flex-col">
              <!-- Needs Gathering -->
              <div class="w-2/3 mb-20  bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="needsGathering">
              ...
              <!-- Fonctionalities -->
              <div class="w-2/3 my-20 ml-auto text-right  bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="functionnalities">
              ...
              <!-- Technical Stack -->
              <div class="w-2/3 my-20 bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="technicalStack">
              ...
              <!-- MCD -->
              <div class="w-2/3  my-20 ml-auto text-right bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="MCD">
              ...
              <div class="w-2/3 my-20 bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="wireframesMockups">
              ...
              <!-- Backoffice -->
              <div class="w-2/3 my-20 ml-auto text-right  bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="backoffice">
              ...
              <!-- Showcase Part -->
              <div class="w-2/3 mt-20 bg-gray-800 p-6 h-[400px] rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700" id="userInterface">
        ...
        <!-- Gallery -->
        <section class="my-20 mx-auto w-10/12 h-[900px]">
            <h2 class="text-5xl text-center my-10">Galerie du Projet</h2>
            <div class="grid grid-cols-3 gap-4">
                <!-- Add images or carousel here -->
            </div>
        </section>
