<template>
    <div class="text-slate-100 font-inter scroll-smooth">
        ...
        <section class="my-20 mx-auto px-4 md:w-10/12 md:flex-col md:flex">
            <!-- Project phases -->
            <!-- Summary -->
            <div class="mb-20 w-full bg-gray-800 p-6 rounded-lg shadow-xl hover:shadow-2xl transition hover:bg-gray-700">
                <p class="text-3xl font-semibold text-center mb-8">Résumé du projet</p>
                <p class="text-xl leading-relaxed">La genèse de ce projet repose sur une philosophie simple : une
                    progression constante nécessite un système robuste. Pour cela, j'ai construis un socle permettant à
                    ...
                    sous-objectifs, routines et tâches, formant ainsi une hiérarchie claire et actionnable.</p>
